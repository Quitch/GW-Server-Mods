...
// live_game_players/ui.js: the server mods' scripts for this panel, from the
...
const URL = "coui://ui/mods/com.example/live_game_players.js";

describe("live_game_players ui", () => {
  it("loads the panel's server mod scripts", () => {
    ...
    const ctx = createContext({
      ...
      sessionStorage: fakeSessionStorage({
        gw_server_mods_scenes: JSON.stringify({ live_game_players: [URL] }),
      }),
    });

    loadScene(ctx, "live_game_players");
  ...
  it("logs rather than throws when the shared modules did not load", () => {
    ...
    loadFile(ctx, "live_game_players/ui.js");
